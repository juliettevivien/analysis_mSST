...
# pick tests to run:
single_sess_indep = True # test of independence assumption at the single session level, by comparing RT distributions of correct GO and unsuccessful STOP trials
group_level_indep = True # test of independence assumption at the group level, by comparing RT distributions of correct GO and unsuccessful STOP trials
single_sub_rt_ssd_relation = True # test of the relation between RT and SSD at the single subject level
group_rt_ssd_relation = True # test of the relation between RT and SSD at the group level
check_success_rate = True # test of the success rate, flag subjects with success rate on GO trials <70% and success rate on STOP trials <35% or >65% for exclusion
