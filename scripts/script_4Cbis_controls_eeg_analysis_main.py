...
included_subjects = [subj for subj in included_subjects if subj.startswith('C')]
...
fmax = 80
saving_path_group0 = os.path.join(results_path, 'control_group_level', 'eeg_perc_sig_change', freq_wide)
...
included_subjects.remove('C003 mSST') # head tremor artifacts, EEG recording bad
included_subjects.remove('C007 mSST')  # head tremor artifacts, EEG recording bad
